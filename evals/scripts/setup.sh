...
build_extension() {
  echo "🔨 Building the Mayai Code extension..."
  cd ..
  mkdir -p bin
...
echo -n "🗄️ Syncing Mayai Code evals database... "
...
read -p "💻 Do you want to build a new version of the Mayai Code extension? [currently $current_version] (y/N): " build_extension
