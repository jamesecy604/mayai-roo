...
The Mayai Code extension exposes an API that can be used by other extensions. To use this API in your extension:
...
await api.startNewTask("Hello, Mayai Code API! Let's make a new project...")
