...
- [I. योगदान करने से पहले](#i-योगदान-करने-से-पहले)
    ...
    - [3. Mayai Code कम्युनिटी से जुड़ें](#3-roo-code-कम्युनिटी-से-जुड़ें)
...
Mayai Code के पास एक स्पष्ट विकास रोडमैप है जो हमारी प्राथमिकताओं और भविष्य की दिशा को दर्शाता है। इसे समझने से आपको मदद मिलेगी:
...
### 3. Mayai Code कम्युनिटी से जुड़ें

Mayai Code कम्युनिटी से जुड़ना शुरू करने का एक शानदार तरीका है:

- **मुख्य तरीका**:
    1.  [Mayai Code Discord कम्युनिटी](https://discord.gg/roocode) से जुड़ें।
...
- **Good First Issues**: हमारे [Mayai Code Issues प्रोजेक्ट](https://github.com/orgs/RooVetGit/projects/1) के "Issue [Unassigned]" सेक्शन को देखें।
- **डाक्यूमेंटेशन**: यह `CONTRIBUTING.md` कोड योगदान के लिए मुख्य गाइड है, लेकिन अगर आप अन्य डाक्यूमेंटेशन (जैसे यूजर गाइड या API डाक्यूमेंटेशन) में योगदान करना चाहते हैं, तो [Mayai Code Docs रिपॉजिटरी](https://github.com/RooVetGit/Roo-Code-Docs) देखें या Discord कम्युनिटी में पूछें।
...
4.  **एक्सटेंशन डिबग करें**: VS Code में `F5` दबाएं (या **Run** → **Start Debugging**) ताकि Mayai Code के साथ नया Extension Development Host विंडो खुले।
